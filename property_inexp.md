# Property Through the Cycle
## A Plain-English Guide for First-Time UK Landlords

---

## Who This Book Is For

This book is for someone who has £50,000–£80,000 in savings, is thinking seriously about buying their first buy-to-let property, and does not yet know where to start.

You do not need a finance background to read it. Every formula and statistical model is in the appendices — the main text uses plain English and simple rules of thumb throughout.

The book has one central argument: **the biggest mistake first-time landlords make is analysing the property and ignoring the economic environment around it.** Two landlords can own identical properties and have completely different experiences, simply because one bought in 1996 and the other bought in 2022. Understanding why — and using that knowledge to make better decisions — is what this book teaches.
...
### Chapter 2 — The Four Things That Drive Property Values
...
### Chapter 3 — What Kind of Landlord Do You Want to Be?
...
House prices fell 21% from peak to trough. 1.5 million homeowners were in negative equity — their property was worth less than their mortgage. People handed keys back to lenders. Portfolios were wiped out.

Then, on 16 September 1992 — Black Wednesday — the Bank of England was forced to withdraw from the European Exchange Rate Mechanism after a speculative attack on the pound. The base rate, which had been raised to 15% in a desperate attempt to defend the currency, was cut almost immediately. By the end of 1992 it was at 7%. By 1993, at 6%. The recovery began.
...
In 1996, the buy-to-let mortgage was formally launched. For the first time, lenders offered mortgages specifically designed for landlords, assessed on the rental income of the property rather than the personal salary of the borrower. The BTL market transformed from a cottage industry into a profession.
...
At the peak, BTL mortgages were 10% of all new mortgage lending.
...
Landlords on variable rate mortgages or short fixed-rate deals — many of which had been locked in at 1–2% in 2020–2021 — found themselves rolling onto 6–7% mortgages in 2022–2023. For a £150,000 mortgage, the difference between 2% and 6.5% is approximately £6,750 per year in additional interest. Many properties that had been cashflow-positive at 2% rates became cashflow-negative at 6.5% rates.
...
## PART THREE: YOUR FIRST PROPERTY
...
|---|---|---|---|
| North | £80,000–£160,000 | 5.5–7.5% | Highest yields; thinner buyer pool when you sell |
| Midlands | £120,000–£200,000 | 5.0–6.5% | Good logistics and employment; growing demand |
...
| Property age | What to budget for maintenance per year |
|---|---|
| Under 15 years | £300–£800 |
| 15–50 years | £500–£5,000 |
...
The rule of thumb: your annual rent should cover your annual mortgage interest at least 1.25 times over. This is called the Interest Coverage Ratio, or ICR. The 1.25 threshold is what most BTL lenders use to assess affordability.
...
**Question 2: Does the rent cover all your costs?**

Your mortgage is not your only cost. For every property you own, budget for the following every year:

| Cost | Typical annual amount |
|---|---|
| Letting agent full management (see note) | £1,500–£1,900 on £900/month rent |
...
## PART FOUR: MANAGING YOUR INVESTMENT
...
| Cost | Typical annual amount |
|---|---|
| Letting agent full management (12%) | £1,296 on £900/month rent |
| Buildings insurance | £200–£400 |
| Landlord liability insurance | £100–£200 |
...
| Cost | Typical amount when it occurs |
|---|---|
| Maintenance: minor | £50–£300 |
| Maintenance: major (boiler, plumbing) | £500–£3,000 |
| Void period | Monthly rent × void months |
...
## PART FIVE: GROWING YOUR PORTFOLIO
...
### Appendix A — UK Macro Data Table, 1983 H1 – 2024 H2

Full semi-annual dataset: year, half, House Price Index (base 100 = 1983 H1), Bank of England base rate, estimated annualised rental growth, CPI/RPI inflation.
...
### Appendix C — SDLT Calculator (Additional-Property Surcharge)
...
### Appendix D — EPC Upgrade Economics

| EPC Band | Purchase Discount | Upgrade Cost | Value Uplift | Rent Uplift | Approx. Payback on Rent |
|---|---|---|---|---|---|
| D → C | 5% | £5,000 | 6% | 10% | ~6 months |
| E → C | 8% | £8,000 | 10% | 10% | ~10 months |
| F → C | 12% | £10,000 | 15% | 10% | ~12 months |
| G → C | 15% | £10,000 | 18% | 10% | ~12 months |
...
Annual mortgage cost = mortgage balance × rate
ICR                  = annual rent / annual mortgage cost
```

Example: £900/month rent, £142,500 at 6.5%
- Annual rent: £10,800
...
Stressed mortgage cost = mortgage balance × stressed rate
Stressed ICR           = annual rent / stressed mortgage cost
```
...
|---|---|
| AST | Assured Shorthold Tenancy — the standard rental contract since 1988 |
| BTL | Buy-to-Let — buying a property specifically to rent it out |
| BRRR | Buy, Refurbish, Rent, Refinance — equity recycling strategy |
| Cash buffer | Reserve held for unexpected costs. Not the same as your deposit. |
| CGT | Capital Gains Tax — tax on profit when you sell a property. Currently 24% for higher-rate taxpayers on residential gains. |
| Completion | The day money transfers and you get the keys |
| EICR | Electrical Installation Condition Report — required every 5 years for rental properties |
| EPC | Energy Performance Certificate — rated A (best) to G (worst) |
| Exchange | The legally binding moment when both parties sign contracts |
| GFC | Global Financial Crisis — 2007–2009 |
| HMO | House in Multiple Occupation — let by the room to 3+ unrelated tenants, requires a licence |
| HPI | House Price Index — measures change in property prices over time |
| ICR | Interest Coverage Ratio — annual rent divided by annual mortgage interest. Must be ≥ 1.25 |
| LTV | Loan to Value — your mortgage as a percentage of the property value. 75% LTV = 25% deposit. |
| Negative equity | When your mortgage exceeds your property's market value |
...
**At the viewing**
- [ ] Boiler age and last service date checked
- [ ] Visible damp or water staining noted
- [ ] Roof and guttering inspected from outside
- [ ] Windows — double glazed? Any failed seals?
- [ ] Consumer unit (fuse box) age noted
- [ ] EPC certificate reviewed

**After offer accepted**
- [ ] Solicitor instructed
- [ ] Survey commissioned (Level 2 minimum)
- [ ] Mortgage application submitted
- [ ] Buildings insurance arranged (required before exchange)

**On completion**
- [ ] Gas Safety Certificate obtained
- [ ] EICR obtained or date of last one confirmed
- [ ] Letting agent appointed and management agreement signed
- [ ] Remortgage date noted in calendar (3-month reminder set)

**Before tenant moves in**
- [ ] Detailed inventory conducted and photographed
- [ ] Deposit protected in approved scheme within 30 days
- [ ] Prescribed information served to tenant
- [ ] How to Rent Guide provided
- [ ] EPC, Gas Safety Certificate, and EICR provided to tenant

**Every 6 months**
- [ ] Rent received and reconciled
- [ ] Cash buffer reviewed (still adequate?)
- [ ] Remortgage date checked

---

### Appendix J — Costs at a Glance
...
|---|---|
| Letting agent full management (14–16% all-in) | 14–16% of gross rent |
| Buildings + landlord liability insurance | £300–£600 |
| Gas Safety Certificate | £70–£150 |
...
| Item | Typical cost |
|---|---|
| Estate agent | 1–1.5% of sale price |
| Solicitor | £800–£1,500 |
| CGT (if applicable) | 24% of gain above annual exempt amount |
